...
atlas_file = pyglet.resource.file('atlas.txt', 'r')
...
big_nums, small_nums = [], []
for i in range(10):
    big_nums.append(vars()['font_0' + str(48 + i)].get_image_data())
    small_nums.append(vars()['number_score_0' + str(i)].get_image_data())
